...
public class UsersResource {
    ...
    private EntityManagerFactory getEmf() {
      if (emf == null) {
        emf = Persistence
          .createEntityManagerFactory("BookmarkPU");
    ...
    public List<UserEntity> getUsers() {
        return getEmf().createEntityManager().createQuery("SELECT u from UserEntity u").getResultList();
    }
    
    @Path("{userid}/")
    public UserResource getUser(@PathParam("userid") String userid) {
        return new UserResource(uriInfo, getEmf().createEntityManager(), userid);
    }
